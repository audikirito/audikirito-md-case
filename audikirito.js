...
let buttonMessage = {
image: {url: `https://telegra.ph/file/a3e66e0fa840b08236c75.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
thumbnail: fs.readFileSync("Media/theme/audikirito.jpg"),
mediaType:1,
...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = ` 𝘔𝘢𝘥𝘦 𝘉𝘺 ${author} SUBSCRIBE https://www.youtube.com/`
				let buttons = [
...
case 'setthumb':{
                ...
                await fs.writeFileSync('./Media/theme/audikirito.jpg', media)
               m.reply(mess.success)
            }
          break
...
case 'swm': case 'stickerwm': case 'wm': case 'take': {  
            ...
            let text2 = q.split("|")[1]
              ...
              if (!text1) return m.reply(`Example! : ${order + ' ' + `audikirito`}`)    
              if (!text2) return m.reply(`Example! : ${order + ' ' + `audikirito`}`)
                XeonBotInc.sendMessage(from, { react: { text: "⏱️", key: m.key }})
          try{ 
...
┗─────────────────⬣`
      let ments = [ownernya, me, ini_mark]        
            ...
            let buttonMessage = {
  document: fs.readFileSync('./Media/theme/audi.xlsx'),
...
let fot = `MADE BY audikirito
`
const listMessage = {
footer: fot,
text: 'Made By audikirito',
title: con,
